...
<head>
  ...
  <link href="src/addited.css" rel="stylesheet">
</head>
<body class="">
    <!--Navigation Bar-->
    ...
    <!--slideShow-->      
        <div class="rounded-xl flex flex-row">
            <div class="w-3/4 relative h-full">                 
                    <div class="ml-1">
                    
                    <div class="mySlides fade">
                      <div class="numbertext">1 / 3</div>
                      <img src="src/img/online-banking.jpg" class="rounded-b-xl" style="width:100%">
                      <div class="text">Caption Text</div>
                    </div>
                    
                    <div class="mySlides fade">
                      <div class="numbertext">2 / 3</div>
                      <img src="src/img/profesional.png" class="rounded-b-xl" style="width:100%">
          ...
          <div class="w-1/4  h-80 max-h-[20rem] bg-slate-100">
            <form action="src/connect.php"  method="POST" class="flex flex-col gap-1 px-5">
              <div class="flex justify-center">
                <img src="src/img/best.jpg" alt="Avatar" class="avatar w-24 rounded-full">
              </div>
              <div class="">
                <label for="uname"><b>Username</b></label>
                <input type="text" class="w-full py-[12px] px-[20px] border border-green-900 rounded" placeholder="Enter Username" name="username" required>
              </div>
            
                <div class="">
                  <label for="psw"><b>Password</b></label>
                <input class="w-full py-[12px] px-[20px] border border-green-900 rounded" type="password" placeholder="Enter Password" name="password" required>
                </div>
                    
                  <button type="submit" class="py-2 px-5 bg-green-700 rounded" value="register" name="submit">Login</button>
